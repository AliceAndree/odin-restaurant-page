...
const createMenuSection = () => {
  ...
  menuParagraph.innerHTML = `The KT is where culinary innovation meets the timeless charm of breakfast and lunch classics. 
                                ...
                                Savor the flavors of Denver from decadent French toast to savory benedicts, each dish at The KT is crafted to perfection, making us the go-to spot for weekend brunch in Denver. 
                                Whether you're indulging in a family-friendly brunch or seeking the perfect brunch spot for a lazy Sunday, The KT's unique menu caters to all.`;
